...
void base_test_6() {
    ...
    update_cache_meta_test(hart_id, way_id, cache_line_id, new_coh_state, tag, global_clock+10);
...
// Register the test
REGISTER_TEST("Load from reorder buffer in different harts", base_test_6);